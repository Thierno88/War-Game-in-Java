...
class Jogador {
	...
	void receberExercitos() {
		...
		addExercitos(Math.max(1,numExercitosRecebidos));
	}
	...
	void removeCartasPorForma(String forma, int quantidade) {
	...
	List<String> getContinentesString() {
